...
_UGC_INSTRUCTION = (
    ...
    "- l'ordre des objets raconte la petite scène: le SUJET RÉELLEMENT NOMMÉ "
    "dans l'extrait d'abord (si la personne parle d'une voiture, la scène "
    "commence par une voiture), le bénéfice ou la preuve en dernier;\n"
    "- n'utilise QUE ce vocabulaire d'objets, en anglais, tel quel: "
    "{vocabulary};\n"
