...
_EDITORIAL_INSTRUCTION = (
    ...
    "- RÈGLE DE PRÉCISION (la plus importante): chaque objet doit correspondre à quelque chose de RÉELLEMENT dit dans l'extrait. Interdiction d'ajouter un objet dont l'extrait ne parle pas: la scène doit amener à l'écran ce que la personne dit, à l'instant où elle le dit;\n"
